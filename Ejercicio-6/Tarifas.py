...
dia = int(input("Dia de la semana (1=lunes ... 7=domingo): "))
estudiante = input("¿Eres estudiante? (s/n): ").lower()
miembro = input("¿Eres miembro? (s/n): ").lower()
metodo = input("Metodo de pago E(efectivo) T(tarjeta): ").lower()
...
if descuento > 0.60:
    descuento = 0.60
tarifa_final = tarifa_inicial * (1 - descuento) * (1 + recargo)
